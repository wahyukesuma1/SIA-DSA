...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1264481209ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pa_asd&table=mahasiswa">`pa_asd`.`mahasiswa`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pa_asd&table=tabungan">`pa_asd`.`tabungan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pa_asd&table=account">`pa_asd`.`account`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pa_dbms&table=tb_transaksi">`pa_dbms`.`tb_transaksi`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pa_dbms&table=tb_petugas">`pa_dbms`.`tb_petugas`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pa_dbms&table=tb_penyewa">`pa_dbms`.`tb_penyewa`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pa_dbms&table=tb_pemilik">`pa_dbms`.`tb_pemilik`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pa_dbms&table=tb_properti">`pa_dbms`.`tb_properti`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2b4b4f456c465545596e40566c2a2e41">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="pa_asd" targettable="mahasiswa">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `mahasiswa`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pa_asd" targettable="mahasiswa">
                            <div class="action_content">
